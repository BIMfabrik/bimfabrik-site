document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    ...
    buildingDataHub: {
      ...
      hubOverviewTitle: { en: "Overview", de: "Übersicht" },
      hubOverviewText: { en: "A portfolio-wide command view for occupancy, readiness, risk and open actions.", de: "Eine portfolioweite Kommandosicht auf Auslastung, Bereitschaft, Risiko und offene Maßnahmen." },
      hubFinanceTitle: { en: "Finance", de: "Finanzen" },
      hubFinanceText: { en: "Capex, opex, cash planning, exposure and variance in one structured layer.", de: "Capex, Opex, Cash-Planung, Exposure und Abweichungen in einer strukturierten Ebene." },
      hubLeasingTitle: { en: "Leasing", de: "Vermietung" },
      hubLeasingText: { en: "Units, vacancy, tenant flow and rent status connected back to the building graph.", de: "Einheiten, Leerstand, Mieterfluss und Mietstatus direkt mit dem Gebäudegrafen verbunden." },
      hubProjectsTitle: { en: "Construction projects", de: "Bauprojekte" },
      hubProjectsText: { en: "Development and fit-out progress, milestones, budget pressure and handover readiness.", de: "Entwicklungs- und Ausbaufortschritt, Meilensteine, Budgetdruck und Übergabebereitschaft." },
      hubStatsTitle: { en: "Statistics", de: "Statistik" },
      hubStatsText: { en: "Portfolio KPIs, trend views and benchmark snapshots for leadership reporting.", de: "Portfolio-KPIs, Trendansichten und Benchmark-Snapshots für das Management-Reporting." },
